 ...
 * @author Shai Almog
 */
public class BaseFormClient extends Form {

    public BaseFormClient() {
    }

    public BaseFormClient(Layout contentPaneLayout) {
        super(contentPaneLayout);
    }

    public BaseFormClient(String title, Layout contentPaneLayout) {
    ...
    protected void addSideMenu() {
        ...
        tb.addMaterialCommandToSideMenu("Presse", FontImage.MATERIAL_PRINT, null);
        tb.addMaterialCommandToSideMenu("Shop", FontImage.MATERIAL_SHOPPING_BAG,FontImage.MATERIAL_SHOPPING_BAG, e -> new ListProductsClientForm().show());
